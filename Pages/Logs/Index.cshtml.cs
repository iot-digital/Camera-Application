...
namespace ParkingDemo.Pages.Logs;
...
public class IndexModel : PageModel
{
    ...
    public async Task<IActionResult> OnGetAsync(int? id)
    {
        ...
        TotalCount = await _repository.GetDeviceLogsCountAsync(id);

        CalculatePageNumbers(PageNumber, TotalCount);

        Logs = await _repository.GetDeviceLogsAsync(
            id,
    ...
    public async Task<IActionResult> OnPostFilterAsync(int pageNumber = 1)
    {
        ...
        TotalCount = await _repository.GetDeviceLogsCountAsync(
            ParkingSlotId,
            Search,
            StartDate,
            EndDate,
    ...
    {
        var result = await _repository.DeleteLogAsync(id);
